...
public interface IOrderRepository {
    ...
    /**
     * Creates a new order with the given information (original method for backward compatibility)
     *
    ...
    /**
     * Creates a new order with enhanced details including store name, payment method, and delivery address
     *
     * @param storeId The ID of the store
     * @param userName The username of the buyer
     * @param products Map of product IDs to quantities
     ...
     * @return The ID of the newly created order
     */
    UUID createOrderWithDetails(UUID storeId, String userName, Map<UUID, Integer> products,
                                double totalPrice, double finalPrice, LocalDateTime orderDate,
    ...
    /**
     * Updates order details such as store name, payment method, and delivery address
     *
     * @param orderId The order ID
     * @param storeName The store name (can be null to keep current)
     * @param paymentMethod The payment method (can be null to keep current)
     * @param deliveryAddress The delivery address (can be null to keep current)
     * @return true if the update was successful
     */
    boolean updateOrderDetails(UUID orderId, String storeName, String paymentMethod, String deliveryAddress);
