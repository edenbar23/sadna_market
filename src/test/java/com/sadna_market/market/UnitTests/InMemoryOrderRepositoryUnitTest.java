...
public class InMemoryOrderRepositoryUnitTest {
    ...
    void setUp() {
        ...
        testTransactionId = 12345; // Example transaction ID
    ...
    void testCreateOrder_ValidParameters_CreatesOrder() {
        ...
        int transactionId = 11111; // int transaction ID

        System.out.println("Creating new order for user: " + userName + " in store: " + storeId);
        UUID orderId = orderRepository.createOrder(
                storeId, userName, products, totalPrice, finalPrice, orderDate, status, transactionId
        );
        ...
        System.out.println("Expected transaction ID: " + transactionId);
        System.out.println("Actual transaction ID: " + order.getTransactionId());
        assertEquals(transactionId, order.getTransactionId(), "Transaction ID should match");
    ...
    void testSetDeliveryId_ExistingOrder_DeliveryIdSet() {
        ...
        System.out.println("Setting delivery ID: " + deliveryId + " for order: " + testOrder.getOrderId());
        boolean updated = orderRepository.setDeliveryId(testOrder.getOrderId(), deliveryId);
        ...
        assertEquals(deliveryId, updatedOrder.get().getDeliveryId(), "Delivery ID should match");
    }
